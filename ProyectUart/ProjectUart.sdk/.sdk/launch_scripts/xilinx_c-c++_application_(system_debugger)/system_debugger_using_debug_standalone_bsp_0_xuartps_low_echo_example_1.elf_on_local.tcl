...
rst -processor
targets -set -nocase -filter {name =~ "ARM*#0" && jtag_cable_name =~ "Digilent Zybo Z7 210351A78402A"} -index 0
dow C:/Xilinx/Xilinx_Training/ProyectUart/ProjectUart.sdk/standalone_bsp_0_xuartps_low_echo_example_1/Debug/standalone_bsp_0_xuartps_low_echo_example_1.elf
bpadd -addr &main
