...
HD_PWD='C:/Xilinx/Xilinx_Training/ProyectUart/ProjectUart.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log designbd_uart_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source designbd_uart_wrapper.tcl
