...
HD_PWD='C:/Xilinx/Xilinx_Training/ProyectUart/ProjectUart.runs/designbd_uart_processing_system7_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log designbd_uart_processing_system7_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source designbd_uart_processing_system7_0_1.tcl
