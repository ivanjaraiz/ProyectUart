...
HD_PWD='C:/Xilinx/Xilinx_Training/ProyectUart/ProjectUart.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log designbd_uart_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source designbd_uart_wrapper.tcl -notrace
